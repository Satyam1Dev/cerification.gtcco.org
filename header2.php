...
<body>
    ...
    <!-- ======= Header ======= -->
    <header id="header" class="d-flex flex-column align-items-center bg-primary" style="height: 120px;">
        <!-- Top Bar -->
        ...
        <div class="container-fluid container-xxl d-flex align-items-center mt-2">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="<?php echo $Web_Url; ?>#speakers">Services</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="<?php echo $Web_Url; ?>online assignment system">Get Accredited</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="<?php echo $Web_Url; ?>online assignment system">Certificate Verification</a></li>
                            <li><a class="dropdown-item" href="<?php echo $Web_Url; ?>online assignment system">Learning Partner Verification</a></li>
                        </ul>
                    </li>
